...
const Service = () => {
  return (
    ...
    <section className='service-section flex flex-wrap'>
        ...
        <div className='w-full md:w-3/6 bg-[url("./service2.png")] bg-cover bg-center h-[200px] md:h-[410px] relative after:absolute after:content[""] after:top-0 after:left-0 after:w-full after:h-full after:bg-b after:opacity-[0.5] z-[1] after:z-[-1] mb-[10px] md:mb-0'>
        ...
        <div className='w-full md:w-3/6 bg-[url("./service3.png")] bg-cover bg-center h-[200px] md:h-[410px] md:text-end relative after:absolute after:content[""] after:top-0 after:left-0 after:w-full after:h-full after:bg-b after:opacity-[0.5] z-[1] after:z-[-1] mb-[10px] md:mb-0'>
            <div className='w-[90%] md:w-[80%] absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]'>
                <h3 className='text-w font-bold text-[20px] md:text-[30px] font-pop mb-[30px]'>Supply of national industries.</h3>
                <a className='text-w md:text-[16px] text-[12px] font-semibold font-pop py-[10px] px-[30px] bg-c1 uppercase hover:bg-w hover:text-b transition duration-300 ease-linear' href="#">Learn more</a>
            </div>
        </div>
        <div className='w-full md:w-3/6 bg-[url("./service1.png")] bg-cover bg-center h-[200px] md:h-[410px] relative after:absolute after:content[""] after:top-0 after:left-0 after:w-full after:h-full after:bg-b after:opacity-[0.5] z-[1] after:z-[-1] mb-[10px] md:mb-0'>
            <div className='w-[90%] md:w-[80%] absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]'>
